"""Auto-generated happy path tests for piazza_sdk.domain.generic."""
...
import piazza_sdk.domain.generic as mod
...
@pytest.mark.asyncio
async def test_happy_path_page_event(rpc_mock):
    with contextlib.suppress(Exception):
        await mod.page_event(rpc_mock)


@pytest.mark.asyncio
async def test_happy_path_sanitize_html(rpc_mock):
    with contextlib.suppress(Exception):
        await mod.sanitize_html(rpc_mock)
