"""Auto-generated happy path tests for piazza_sdk.domain.preferences."""
...
import piazza_sdk.domain.preferences as mod
...
@pytest.mark.asyncio
async def test_happy_path_get_preferences(rpc_mock):
    with contextlib.suppress(Exception):
        await mod.get_preferences(rpc_mock)


@pytest.mark.asyncio
async def test_happy_path_update_preferences(rpc_mock):
    with contextlib.suppress(Exception):
        await mod.update_preferences(rpc_mock)
