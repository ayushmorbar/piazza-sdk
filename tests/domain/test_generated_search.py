"""Auto-generated happy path tests for piazza_sdk.domain.search."""
...
import piazza_sdk.domain.search as mod
...
@pytest.mark.asyncio
async def test_happy_path_search(rpc_mock):
    with contextlib.suppress(Exception):
        await mod.search(rpc_mock)
