"""Auto-generated happy path tests for piazza_sdk.domain.statistics."""
...
import piazza_sdk.domain.statistics as mod
...
@pytest.mark.asyncio
async def test_happy_path_get_statistics(rpc_mock):
    with contextlib.suppress(Exception):
        await mod.get_statistics(rpc_mock)
